...
If the User does not accept the invitation, you can either Disable the account or Remove it. In cases where you do not want to do this, you can [contact YDJ](ydj/ydj-contact.md) for assistance.
